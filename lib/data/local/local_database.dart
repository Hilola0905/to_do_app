...
import 'package:to_do_app/data/model/category/category_model_constants.dart';

import '../model/task_model.dart';
import '../model/task_model_constants.dart';
...
class LocalDatabase {
  ...
  static Future<CategoryModel> insertCategory(CategoryModel categoryModel) async {
    ...
    final db = await databaseInstance.database;
    int savedTaskID =
        await db.insert(TaskModelConstants.tableName, categoryModel.toJson());
    debugPrint("SAVED ID:$savedTaskID");
  ...
  static Future<List<CategoryModel>> getAllCategory() async {
    ...
    List json = await db.query(CategoryModelConstants.name, orderBy: orderBy);
